...
import { createContactController, deleteContactController, readAllContactsController, updateContactController } from "../controllers/contact/contact.controllers"
...
contactRoutes.get('/:id', tokenValid, checkIdContactExists, readAllContactsController)
contactRoutes.patch('/:id', tokenValid, validatedBody(contactUpdate),checkIdContactExists, checkEmailExists, checkNameExists, updateContactController)
contactRoutes.delete('/:id', tokenValid, checkIdContactExists, deleteContactController)
